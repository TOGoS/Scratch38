...
public class Main {
	...
	public static void main(String[] args) {
		...
		check("sha1(\"abc\")", "a9993e364706816aba3e25717850c26c9cd0d89d",
			HMACSHA1Util.toHex(HMACSHA1Util.sha1(ascii("abc"))));
		check("sha1(\"\")", "da39a3ee5e6b4b0d3255bfef95601890afd80709",
			HMACSHA1Util.toHex(HMACSHA1Util.sha1(ascii(""))));
		
		// HMAC-SHA1 test vectors (RFC 2202)
		check("hmac case 1", "b617318655057264e28bc0b6fb378c8ef146be00",
			HMACSHA1Util.toHex(HMACSHA1Util.hmacSha1(repeat(0x0b, 20), ascii("Hi There"))));
		check("hmac case 2", "effcdf6ae5eb2fa2d27416d5f184df9c259a7c79",
			HMACSHA1Util.toHex(HMACSHA1Util.hmacSha1(ascii("Jefe"), ascii("what do ya want for nothing?"))));
		check("hmac case 3", "125d7342b9ac11cd91a39af48aa17b4f63f175d3",
			HMACSHA1Util.toHex(HMACSHA1Util.hmacSha1(repeat(0xaa, 20), repeat(0xdd, 50))));
		...
		System.out.println("HELO example HMAC-SHA1 (secret \"foo\"): " +
			HMACSHA1Util.toHex(HMACSHA1Util.hmacSha1(ascii("foo"), ascii(heloMessage))));
